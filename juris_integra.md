# Jurisprudência — textos *in albis* (literais)
### Apoio ao Parecer Interno (CISPAR / Edital 001/2026)

> **Advertência essencial.** A API "Lei na Mão TCE" devolve, na maioria dos casos, apenas um **resumo gerado pelo provedor** (campo `ai_summary`) — isto é, **paráfrase**, que **não** pode ser citada como texto literal. Abaixo, separa-se o que foi obtido **verbatim de fonte oficial** (Seções 1 e 2) do que está disponível **apenas como resumo do provedor** (Seção 3), cujo inteiro teor deve ser extraído do portal oficial antes de citação em peça.

---

## Seção 1 — Textos oficiais reproduzidos na íntegra (verbatim)
...
*(Fonte: Tribunal de Contas da União — conferida em fonte oficial.)*

### 1.2. Súmula 247/TCU
> "É obrigatória a admissão da adjudicação por item e não por preço global, nos editais das licitações para a contratação de obras, serviços, compras e alienações, cujo objeto seja divisível, desde que não haja prejuízo para o conjunto ou complexo ou perda de economia de escala, sendo facultada a apresentação de proposta para um, alguns ou todos os itens."
*(Fonte: TCU — conferida em fonte oficial.)*

### 1.3. Súmula 263/TCU
> "Para a comprovação da capacidade técnico-operacional das licitantes, e desde que limitada, simultaneamente, às parcelas de maior relevância e valor significativo do objeto a ser contratado, é legal a exigência de comprovação da execução de quantitativos mínimos em obras ou serviços com características semelhantes, devendo essa exigência guardar proporção com a dimensão e a complexidade do objeto a ser executado."
*(Fonte: TCU — conferida em fonte oficial.)*

### 1.4. TCE-SC — Consulta n.º 1071/2022 (Processo @CON 22/00308552), Rel. Cons. Herneus João De Nadal — EMENTA (íntegra)
Transcrição literal do documento oficial (Proposta de Voto GAC/HJN-690/2022):
...
### 2.1. TCU — vedação à exigência cumulativa (qualificação econômico-financeira)
Enunciado, atribuído ao **Acórdão 1.842/2013-Plenário** (e à Súmula 275/TCU), reproduzido literalmente:
...
*(Fonte: repositório de jurisprudência — texto a confirmar no inteiro teor do Acórdão 1.842/2013-Plenário no portal do TCU.)*

---

## Seção 3 — Itens disponíveis APENAS como resumo do provedor (NÃO são texto literal)

> Os textos abaixo são o **resumo automático** fornecido pela base "Lei na Mão TCE" (campo `ai_summary`). **Não devem ser citados como literais.** Para uso em peça, extrair a ementa/voto do inteiro teor no portal indicado.

| Decisão | Situação | Onde obter o literal |
|---|---|---|
...
- Apenas as Seções 1 e 2 contêm **texto literal**; a Seção 1 é de **fonte oficial**, a Seção 2 é de fonte secundária confiável **a confirmar no portal**.
- A Seção 3 **não** é texto literal — é o resumo do provedor; foi mantida apenas para indicar onde buscar a íntegra.
- Recomenda-se, antes do protocolo, substituir no Parecer Interno as referências da Seção 3 pelos respectivos **inteiros teores oficiais**.
